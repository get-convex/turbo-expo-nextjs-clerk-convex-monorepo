...
const TestimonialsData = [
  ...
  },
  {
    rating: 5,
    review:
      "Really like the clean design of Notez.io. The AI-driven search is impressively accurate, adding a personal dimension to my notes. Fast and very easy to use.",
    name: "John Collins",
    designation: "Engineer & Author",
    profile: "/images/profile.png",
    feature: true,
  ...
  {
    rating: 5,
    review: "Simply brilliant! Notez.io has elevated my productivity.",
    name: "Moe Partuj",
    designation: "Student",
...
const Testimonials = () => {
  return (
    <section id="reviews" className="bg_image bg_circle relative overflow-hidden">
      <Image src={'/images/blue-circle-right.svg'} width={503} height={531} alt="" className="absolute hidden sm:block -right-40 top-1/4 h-[531px]" />
      <div className="container py-11 sm:py-16 px-6 sm:px-0">
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-center items-start gap-4 pb-10 relative">
          <Image
        ...
        <p className="hidden cursor-pointer sm:block text-black text-2xl not-italic font-extralight leading-[90.3%] tracking-[-0.6px] font-montserrat text-center pb-28">
          View more
        </p>
      </div>
    </section>
