...
const Benefits = () => {
  return (
    <section id="benifits" className="relative">
      <Image src={'/images/blue-circle.svg'} width={503} height={531} alt="" className="absolute hidden sm:block -left-40 -top-48 h-[531px]" />
